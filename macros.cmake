...
macro(get_runtime_dir var)
  ...
  if(DEFINED ENV{RUNTIME_SRC})
    get_filename_component(${var} $ENV{RUNTIME_SRC} REALPATH BASE_DIR "${CMAKE_SOURCE_DIR}")
    message(STATUS "Using runtime source located at ${${var}}")
elseif(EXISTS ${CMAKE_SOURCE_DIR}/runtime)
